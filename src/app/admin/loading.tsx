        ...
        <div className="space-y-8">
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                    {[1, 2].map((i) => (
                        <div key={i} className="flex items-center gap-3 p-4 rounded-xl border-2 border-neutral-200 dark:border-neutral-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {[Package, TrendingUp, AlertCircle, ShoppingBag].map((Icon, i) => (
                    <div key={i} className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-6">
