...
export default async function AdminDashboard() {
    ...
    return (
        <div className="space-y-8">
            {/* Header */}
            <div>
                <h1 className="text-4xl font-bold text-neutral-900 dark:text-white mb-2 transition-colors">Dashboard</h1>
                <p className="text-neutral-600 dark:text-neutral-400 text-lg font-medium transition-colors">Welcome back! Here's what's happening with your store.</p>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-6 transition-colors">
                <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-4 transition-colors">Quick Search</h2>
                    ...
                    <Link href="/admin/products" className="group">
                        <div className="flex items-center gap-3 p-4 rounded-xl border-2 border-neutral-200 dark:border-neutral-700 hover:border-rose-300 dark:hover:border-rose-500 hover:bg-rose-50 dark:hover:bg-rose-900/20 transition-all">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-sm text-neutral-600 dark:text-neutral-400 transition-colors">Find and manage products</p>
                            </div>
                        </div>
                    </Link>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {stats.map((stat) => {
                    ...
                    return (
                        <div key={stat.name} className="bg-white dark:bg-neutral-900 rounded-2xl shadow-sm border border-neutral-200 dark:border-neutral-800 p-6 hover:shadow-md dark:hover:shadow-xl transition-all">
                            ...
                            <h3 className="text-neutral-600 dark:text-neutral-400 text-sm font-bold uppercase tracking-wide mb-1 transition-colors">{stat.name}</h3>
                            <p className="text-4xl font-bold text-neutral-900 dark:text-white transition-colors">{stat.value}</p>
                        </div>
                    )
                })}
            </div>
