/**
 * Settings Service
 * Centralized data access for store settings operations.
 */
 ...
 */
export async function updateSettings(data: UpdateSettingsData): Promise<{ success?: boolean; error?: string }> {
    const supabase = await createClient()
